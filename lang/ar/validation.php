...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'name' => 'الاسم',
        'phone' => 'رقم الهاتف',
        'phone_local' => 'رقم الهاتف (بدون المفتاح)',
        ...
        'name.ar' => 'اسم الباقة بالعربية',
        'name.en' => 'اسم الباقة بالإنجليزية',
        'description' => 'الوصف',
        ...
        'twitter_links' => 'رابط تويتر',
        'whatsapp_link' => 'رابط واتساب',
        'snap_link' => 'رابط سناب شات',
        'tiktok_link' => 'رابط تيك توك',
        'type.twitter_links' => 'رابط تويتر',
        'type.whatsapp_link' => 'رابط واتساب',
        'type.snap_link' => 'رابط سناب شات',
        'type.tiktok_link' => 'رابط تيك توك',

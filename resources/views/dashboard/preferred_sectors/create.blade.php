<x-dashboard.layouts.master title="{{ __('dashboard.add preferred sector') }}">
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <x-dashboard.layouts.breadcrumb now="{{ __('dashboard.add preferred sector') }}">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('dashboard.add preferred sector') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical store" method="POST"
                                action="{{ route('admin.preferred_sectors.store') }}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-6">

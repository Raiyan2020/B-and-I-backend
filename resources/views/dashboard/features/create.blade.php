<x-dashboard.layouts.master title="{{ __('dashboard.add feature') }}">
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <x-dashboard.layouts.breadcrumb now="{{ __('dashboard.add feature') }}">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('dashboard.add feature') }}</h4>
                    </div>
                            ...
                            <form class="form form-vertical store" method="POST"
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <x-dashboard.generalSettings.uploadImage col="12" name="image" folder="features/" src="" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <textarea id="description-ar-icon"
                                                        ...
                                                        rows="4" required>{{ old('description.ar') }}</textarea>
                                                    <div class="form-control-position">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <textarea id="description-en-icon"
                                                        ...
                                                        rows="4" required>{{ old('description.en') }}</textarea>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-align-left"></i>
                                                    </div>
                                                </div>

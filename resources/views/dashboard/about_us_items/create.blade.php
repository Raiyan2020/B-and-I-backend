<x-dashboard.layouts.master title="{{ __('dashboard.add_about_us_item') }}">
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <x-dashboard.layouts.breadcrumb now="{{ __('dashboard.add_about_us_item') }}">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('dashboard.add_about_us_item') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical store" method="POST"
                                action="{{ route('admin.about_us_items.store') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    <div class="row">

                                        <x-dashboard.generalSettings.uploadImage col="12" name="image" folder="about_us/" src="" />
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="description-ar"
                                                    ...
                                                    placeholder="{{ __('dashboard.description') }} {{ __('dashboard.in arabic') }}" required>{{ old('description.ar') }}</textarea>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="description-en"
                                                    ...
                                                    placeholder="{{ __('dashboard.description') }} {{ __('dashboard.in english') }}" required>{{ old('description.en') }}</textarea>

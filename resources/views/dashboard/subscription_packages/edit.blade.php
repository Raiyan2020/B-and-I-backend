<x-dashboard.layouts.master title="{{ __('dashboard.edit_subscription_package') }}">
    <div class="app-content content">
        <div class="content-overlay"></div>
        <div class="header-navbar-shadow"></div>
        <div class="content-wrapper">
            <div class="content-header row"></div>
            <x-dashboard.layouts.breadcrumb now="{{ __('dashboard.edit_subscription_package') }}">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('dashboard.edit_subscription_package') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical store" method="POST"
                                action="{{ route('admin.subscription_packages.update', $row->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name[ar]"
                                                    value="{{ old('name.ar', $row->getTranslation('name', 'ar')) }}" required dir="rtl">
                                                @error('name.ar')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name[en]"
                                                    value="{{ old('name.en', $row->getTranslation('name', 'en')) }}" required dir="ltr">
                                                @error('name.en')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.001" min="0" class="form-control"
                                                    name="price_monthly" value="{{ old('price_monthly', $row->price_monthly) }}" required>
                                                @error('price_monthly')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="description-ar" class="form-control ckeditor-package" name="description[ar]"
                                                    rows="8" dir="rtl" required>{{ old('description.ar', $row->getTranslation('description', 'ar')) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="description-en" class="form-control ckeditor-package" name="description[en]"
                                                    rows="8" dir="ltr" required>{{ old('description.en', $row->getTranslation('description', 'en')) }}</textarea>

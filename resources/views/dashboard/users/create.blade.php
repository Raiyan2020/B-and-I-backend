<x-dashboard.layouts.master title="{{ $createTitle ?? __('dashboard.add user') }}">
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <x-dashboard.layouts.breadcrumb now="{{ $createTitle ?? __('dashboard.add user') }}">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ $createTitle ?? __('dashboard.add user') }}</h4>
                    </div>
                            ...
                            <form class="form form-vertical store" method="POST"
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <x-dashboard.generalSettings.uploadImage col="12" name="image" folder="users/" src="" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="investor_type" class="form-control" required>
                                                        ...
                                                        @foreach($investorTypes ?? [] as $investorType)
                                                            <option value="{{ $investorType->value }}" {{ old('investor_type') === $investorType->value ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="preferred_sector_id" class="form-control" required>
                                                        ...
                                                        @foreach($preferredSectors ?? [] as $preferredSector)
                                                            <option value="{{ $preferredSector->id }}" {{ (string) old('preferred_sector_id') === (string) $preferredSector->id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="investor_experience" class="form-control" required>
                                                        ...
                                                        @foreach($investorExperiences ?? [] as $investorExperience)
                                                            <option value="{{ $investorExperience->value }}" {{ old('investor_experience') === $investorExperience->value ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="password" class="form-control" name="password"
                                                        placeholder="{{ __('dashboard.table password') }}" required>
                                                    <div class="form-control-position">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                    <input type="password" class="form-control"
                                                        ...
                                                        placeholder="{{ __('dashboard.table confirm password') }}" required>
                                                    <div class="form-control-position">
                                                        <i class="fa fa-pencil"></i>
                                                    </div>
                                                </div>

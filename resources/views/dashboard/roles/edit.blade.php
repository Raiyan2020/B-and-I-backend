...
<x-dashboard.layouts.master title="{{__('dashboard.edit roles')}}">
                    ...
                    <div class="col-12">
                        <div class="card role-form-card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-vertical" method="POST" action="{{route('admin.roles.update',$role->id)}}" id="role-form">
                                        @csrf
                                        @method('PUT')

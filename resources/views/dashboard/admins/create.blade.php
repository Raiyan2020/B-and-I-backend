...
<x-dashboard.layouts.master title="{{ __('dashboard.add admin') }}">
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <x-dashboard.layouts.breadcrumb now="{{ __('dashboard.add admin') }}">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('dashboard.add admin') }}</h4>
                    </div>
                            ...
                            <form class="form form-vertical store" method="POST"
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <x-dashboard.generalSettings.uploadImage col="12" name="image" folder="admins/" src="" />
